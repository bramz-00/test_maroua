          ...
          <div>
            <button
              ...
              className={`w-full   font-semibold  text-center 
                ...
                ${isLoading ? 'opacity-50 cursor-not-allowed border-gray-200  text-gray-900 bg-white' : 'bg-blue-500 rounded-md text-white hover:bg-blue-700'} 
                py-2.5 px-5 me-2 text-sm font-medium  rounded-lg border 
            `}
